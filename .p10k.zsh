# Generated by Powerlevel10k configuration wizard on 2021-03-30 at 00:05 +07.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='$(if [[ $CPUTYPE == "arm64" ]]; then echo "\uf179"; else echo "\uf85a"; fi)'
